...
scaler = joblib.load("your_path/d18O_xgb.2.pp")
...
xgb_model = joblib.load("your_path/d18O_xgb.model2.pkl")
rf_model = joblib.load("your_path/d18O_rf.model2.pkl")
...
training_target = training["d18Of"].values
test_target = test["d18Of"].values
validation_target = validation["d18Of"].values
...
# Save fusion model
save_path = "E:/learn/data/test/model/d18O/"
...
joblib.dump(fusion_model, os.path.join(save_path, "d18O_fusion.model.pkl"))
joblib.dump(scaler, os.path.join(save_path, "d18O_fusion.pp"))
...
save_fusion_feature_importance(xgb_model, rf_model, numeric_predictors_xgb, weight_xgb, weight_fusion,
                               os.path.join(save_path, "d18O_fusion_importance.csv"))
